...
public class AppChooser {
    ...
    private AppChooserCallback mCallBack = null;
    ...
    public void setCallBack(AppChooserCallback callback) {
        mCallBack = callback;
    }

    public interface AppChooserCallback {
        void onAppClickCallback();
    }
}
